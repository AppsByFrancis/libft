...
/*   Updated: 2024/06/14 01:00:17 by fmajer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_allocate(char **array, int position, size_t size)
{
	int	i;
...
int	ft_fill_array(char **array, char const *s, char delimiter)
{
	size_t	str_len;
	int		j;
